...
// import { abtData } from "./Content/AboutContent";
...
//       <div className="AbtUsImgAndComp02abtData01Wrapper">
//         <div className="AbtUsImgAndComp02abtData01WrapperLeft">
//           <img src={aboutUs} alt="" />
//         </div>

//         {abtData01.map((ele, ind) => {
//           return (
//             <div
//               key={ind}
//               className="Comp02abtData01 AbtUsImgAndComp02abtData01WrapperRight"
//             >
//               <article>
//                 <h1>{ele.title}</h1>
//                 <p>{ele.description}</p>
...
//       <div className="AbtUsWhyChooseUs">
//         <div className="AbtUsWhyChooseUsImgWrapperLeft">
//           <img src={aboutUsImage02} alt="" />
//         </div>
//         <div className="AbtUsWhyChooseUsContentsWrapperRight">
//           {abtData.map((section, index) => (
//             <div key={index} className="Comp02Wrapper">
//               {section.title && (
//                 <h1 className="Comp02WrapperMainTitle">{section.title}</h1>
//               )}

//               <div className="Comp02SubTitleAndDscriptionContainerWrapper">
//                 {section.titleANdDescription.map((item, idx) => (
//                   <div
//                     key={idx}
//                     className="Comp02SubTitleAndDscriptionContainer"
//                   >
...
//         </div>
//       </div>
//       <div className="aboutUsLastParaAndImageWrapper">
//         <p>
//           At GDWellness, we believe that sexual wellness is an essential
//           component of overall well-being. Join us on a journey of exploration,
//           pleasure, and empowerment. Welcome to a world of endless
//           possibilities. For any suggestions or feedback or any new product that
//           you may have on your mind, please feel free to speak to one of our
//           Customer Support Executives over the phone or email us
//           support@gdwellness.shop and we will definitely help you out with your
//           request.
//         </p>
//         <img src={aboutUsImage03} alt="" />
//       </div>
//     </div>
//   );
// };
...
// import aboutUsbackgroundImage from "../Images/aboutUsbackgroundImage.webp";
  ...
  return (
    <div className="About">
      ...
      {/* <div className="AboutContainer01">
        <div className="AboutContainer01abtData01">
          {abtData01.map((ele, ind) => {
            return (
              <div
                key={ind}
                className="AboutContainer01abtData01HeadingAndDesc"
              >
                <h2>{ele.title}</h2>
                <p>{ele.description}</p>
              </div>
        ...
        <div className="AboutContainer01ImageWrapper">
          <img src={aboutUsImage02} alt="" />
        </div>
      </div> */}
